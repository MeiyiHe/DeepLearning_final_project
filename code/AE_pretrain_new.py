...
if __name__ == '__main__':
	...
	train_loader = torch.utils.data.DataLoader(unlabeled_trainset, batch_size=BATCH_SIZE, shuffle=True, num_workers=2)
	...
	val_loader = torch.utils.data.DataLoader(unlabeled_valset, batch_size=BATCH_SIZE, shuffle=True, num_workers=2)

...
class UNet(nn.Module):
    ...
    def modify_output(self, in_channels, out_channels, kernel_size=5):
        '''
        This modify the output size to be 800*800, for binary road map prediction
        '''
        block = torch.nn.Sequential(
    ...
    def __init__(self, in_channel, out_channel):
        ...
        self.refit_layer = self.modify_output(in_channels = 1, out_channels = 1)
